...
class RosterTableHistoryBowl extends RosterTableQuizSingleTeam{

    protected $instructions = '<p>Schools participating in this Quiz Bowl event may enter a single team. Teams may have 5 participants and multiple alternates.</p>
