...
class RosterTableMathBowl extends RosterTableQuizSingleTeam{
    ...
    protected $instructions = '<p>Schools participating in this Math Bowl event may enter a single team. Teams may have 4 participants and multiple alternates.</p>
